...
typedef struct {
  ...
  int alfa0, alfa1, count_n, count_ms,count_mv, count_undef, count_init;
...
VAD_DATA *vad_open(float sampling_rate,int alfa0,int alfa1, int count_ms, int count_mv, int init_frames);
